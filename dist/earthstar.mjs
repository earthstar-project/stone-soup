...
var base32BytesToString = (bytes) => "b" + codec.stringify(bytes, myEncoding, {pad: false});
...
var Peer = class {
  constructor() {
    ...
    this.storageMap = new SuperbusMap();
...
var StorageCache = class {
  ...
  _updateCacheOptimistically(doc) {
    this._docCache.forEach((entry, key) => {
      ...
      const docIsDifferent = doc.author !== (latestDoc == null ? void 0 : latestDoc.author) || !isEqual(doc, latestDoc);
